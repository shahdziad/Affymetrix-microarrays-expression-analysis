...
# Samples 46 and 43 were flagged as outliers, with 43 being flagged by 2 methods
...
arrayQualityMetrics(
  ...
  force = TRUE)
# Samples 3, 8 and 46 were flagged as outliers, with 3 and 46 are being flagged by 2 methods
...
# Check class of sdrf column before labelling 
